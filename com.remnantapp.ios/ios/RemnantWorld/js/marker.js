...
function Marker(poiData) {
    ...
    */
    ...
    if(poiData.thumbnail) {
        idleImage = new AR.ImageResource(poiData.thumbnail);
    }
    else {
        idleImage = World.markerDrawable_idle;
    }

    var selectedImage;
    if(poiData.thumbnail) {
        selectedImage = new AR.ImageResource(poiData.thumbnail);
    }
    else {
        selectedImage = World.markerDrawable_selected;
    }

    // create an AR.ImageDrawable for the marker in idle state
    this.markerDrawable_idle = new AR.ImageDrawable(idleImage, 2.5, {
        zOrder: 0,
        opacity: 1.0,
        /*
    ...
    this.markerDrawable_selected = new AR.ImageDrawable(selectedImage, 2.5, {
        zOrder: 0,
        opacity: 0.0,
        onClick: null
    });
    ...
    var title =  (poiData.thumbnail ? "" : poiData.userName);
    ...
    var description = (poiData.thumbnail ? "" : poiData.description);
    // create an AR.Label for the marker's description
    this.descriptionLabel = new AR.Label(description, 0.8, {
        zOrder: 1,
        offsetY: -0.55,
        style: {
            textColor: '#FFFFFF'
