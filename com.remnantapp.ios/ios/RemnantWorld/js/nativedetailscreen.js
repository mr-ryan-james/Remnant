...
var ServerInformation = {
	POIDATA_SERVER: "https://remnantapp.com/api/remnants/",
	POIDATA_SERVER_ARG_LAT: "lat",
	POIDATA_SERVER_ARG_LON: "lng",
	POIDATA_SERVER_ARG_NR_POIS: "distance"
};
...
var World = {
	...
	loadPoisFromJsonData: function loadPoisFromJsonDataFn(poiData) {
		...
		for (var currentPlaceNr = 0; currentPlaceNr < poiData.length; currentPlaceNr++) {
			var singlePoi = {
				"id": poiData[currentPlaceNr].objectId,
				"latitude": poiData[currentPlaceNr].geolocation.latitude,
				"longitude": poiData[currentPlaceNr].geolocation.longitude,
				"altitude": poiData[currentPlaceNr].altitude,
				"title": "Remnant Title",
				"description": poiData[currentPlaceNr].description,
				"thumbnail" : poiData[currentPlaceNr].thumbnail ? poiData[currentPlaceNr].thumbnail.url : null,
				"photo" : poiData[currentPlaceNr].photo ? poiData[currentPlaceNr].photo.url : null,
				userName: poiData[currentPlaceNr].userName
			};
	...
	onMarkerSelected: function onMarkerSelectedFn(marker) {
		...
		document.location = "architectsdk://markerselected?id=" + encodeURIComponent(marker.poiData.id);
	},
	...
	requestDataFromServer: function requestDataFromServerFn(lat, lon) {
		...
		var serverUrl = ServerInformation.POIDATA_SERVER + "?" + ServerInformation.POIDATA_SERVER_ARG_LAT + "=" + lat + "&" + ServerInformation.POIDATA_SERVER_ARG_LON + "=" + lon + "&" + ServerInformation.POIDATA_SERVER_ARG_NR_POIS + "=10000";
        //alert(serverUrl)
